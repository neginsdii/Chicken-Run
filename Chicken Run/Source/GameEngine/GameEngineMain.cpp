...
float GameEngineMain::WINDOW_HEIGHT = 832;
...
{
	m_renderWindow = new sf::RenderWindow(sf::VideoMode((unsigned int)WINDOW_WIDTH, (unsigned int)WINDOW_HEIGHT), "Chicken Run");
...
{		
	...
	sm_deltaTimeClock.restart();
	//sf::Text time(sf::Text(m_lastDT));
	//std::cout << m_lastDT << std::endl;
}
